...
{
    [DbContext(typeof(StrataManagementDbContext))]
    [Migration("20250322102016_UpdateSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi.Models.MaintenanceRequest", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebApi.Models.Owner", b =>
                {
                    ...
                    b.Property<string>("AssignedBuildingId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebApi.Models.MaintenanceRequest", b =>
                {
                    ...
                    b.HasOne("WebApi.Models.Building", null)
                        .WithMany("MaintenanceRequests")
                        .HasForeignKey("BuildingId1");

                    b.HasOne("WebApi.Models.ApplicationUser", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("WebApi.Models.ApplicationUser", "LastChangeBy")
                        .WithMany()
                    ...
                    b.HasOne("WebApi.Models.Tenant", null)
                        .WithMany("MaintenanceRequests")
            ...
            modelBuilder.Entity("WebApi.Models.Owner", b =>
                {
                    b.HasOne("WebApi.Models.Building", "AssignedBuilding")
                        .WithMany("Owners")
